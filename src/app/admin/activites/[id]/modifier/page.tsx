      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-brand-100 p-6">
          ...
          {type === "QCM" && <div className="space-y-4">{qcm.map((q, qi) => <div key={qi} className="p-4 bg-slate-50 rounded-xl space-y-3">
            ...
            <button type="button" onClick={() => { const u=[...qcm]; u[qi]={...u[qi],options:[...u[qi].options,""]}; setQcm(u); }} className="text-xs text-brand-600 font-medium mt-1">+ Ajouter une reponse</button>

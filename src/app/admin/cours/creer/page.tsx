...
export default function CreerCoursPage() {
  ...
  return (
    <div className="max-w-2xl">
      ...
      <div className="mb-6">
        <h1 className="font-heading text-2xl font-bold text-slate-900">Creer un cours</h1>
        <p className="text-sm text-slate-500 mt-1">Definis les informations principales. Tu pourras ajouter des sections et des lecons ensuite.</p>
      </div>

  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-10">
        ...
        <p className="text-brand-400 mt-2 text-lg">Du niveau debutant (A1) a la maitrise (C2). Methode CECRL.</p>
              ...
              <Link key={course.id} href={needsCode ? `/cours/${course.slug}/inscription` : `/cours/${course.slug}`}
                ...
                <div className="p-5">
                  <div className="flex items-center gap-2 mb-2 flex-wrap">
                    ...
                    <span className="text-xs text-brand-300">{course.sections.length} section{course.sections.length !== 1 ? "s" : ""} . {lessonCount} lecon{lessonCount !== 1 ? "s" : ""}</span>
                  </div>
